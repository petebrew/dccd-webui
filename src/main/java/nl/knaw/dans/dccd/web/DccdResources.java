 ...
 * 
 * TODO these values are not adapted to DCCD yet, 
 * and also when refactoring DCCD we want to make use of these values
 * 
 * @author ecco Mar 13, 2009
 * @author lobo (refactored)
 */
public interface DccdResources
{
	...
	String	USER_CONFIRM_EMAIL								= "user.confirmEmail";
	...
	String	USER_COMMONNAME									= "user.commonName";
