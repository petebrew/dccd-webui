 ...
 * @author paulboon
 */
public class SampleTypePanel extends EntityAttributePanel 
{
	private static final long	serialVersionUID	= -5587156736439530373L;
	private static Logger logger = Logger.getLogger(SampleTypePanel.class);
	
	public SampleTypePanel(String id, IModel model) {
		super(id, model, false);
	}

	public SampleTypePanel(String id, IModel model, final boolean editable) {
		super(id, model, editable);
		//super(id, model, false); // only allow view
	}
		
	public class SampleTypePanelView extends Panel {
		private static final long	serialVersionUID	= 4995390576562614985L;

		public SampleTypePanelView(String id, IModel model) {
			super(id, model);
	...
	public class SampleTypePanelEdit extends Panel {
		private static final long	serialVersionUID	= -1439875577530767286L;
		// For the ComboBox			
		private DropDownDataSource listDS;
		
		public SampleTypePanelEdit(String id, IModel model) {
			super(id, model);
			...
			listDS = new DropDownDataSource<String>() {
			    ...
			    public List<String> getValues() {
					...
					return DccdVocabularyService.getService().getTerms("sample.type", langCode);
			    }
