...
public class MorrisDonutChartPanel extends Panel {

	private static final long serialVersionUID = 1L;
;
	private static Logger logger = LoggerFactory.getLogger(MorrisDonutChartPanel.class);
	private String jsonContents;
	private String thisid;

	public MorrisDonutChartPanel(String id, File file) 
	{
		super(id);
		thisid = id;
		logger.info("Instantiating DonutChartPanel");
		...
		add(new DonutChartPanelBehaviour());
		
		
	}
	
	class DonutChartPanelBehaviour extends AbstractBehavior
	{
