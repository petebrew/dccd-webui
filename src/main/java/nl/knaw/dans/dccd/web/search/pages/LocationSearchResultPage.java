 ...
 *
 */
public class LocationSearchResultPage extends BasePage
{
	private Page backPage;
	
	public LocationSearchResultPage(SearchModel searchModel, final SearchPanel callingPanel)
	{
		super(searchModel);
			...
			public void onClick()
			{
		        ...
		        if (page != null)
		        {
		        	...
		        	SearchRequestBuilder requestBuilder = 
		        		((SearchModel)LocationSearchResultPage.this.getDefaultModel()).getRequestBuilder();
		...
		LocationSearchResultPanel locationSearchResultPanel = 
			new LocationSearchResultPanel("locationSearchResultPanel", searchModel) 
			{
