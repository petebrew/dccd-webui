...
/*
 * Note by pboon: copied from eof project package  nl.knaw.dans.easy.web.wicketutil;
 * also note that the PatternValidator needs wicket resources like:
 * PasswordPolicyValidator$PasswordMinimumLengthValidator=Password should be at least 6 characters.
 * etc.
 */
 ...
 * @author Herman Suijs
 */
public final class PasswordPolicyValidator implements IValidator
{
     ...
     */
    public PasswordPolicyValidator add(final IValidator validator)
    {
        if (validator == null)
        {
